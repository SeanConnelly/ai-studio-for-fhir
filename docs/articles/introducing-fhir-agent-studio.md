...
![The guided demo: all twelve agents, each with a description and a Try it link](https://raw.githubusercontent.com/SeanConnelly/ai-studio-for-fhir/main/docs/screenshots/the-demo-page.png)
