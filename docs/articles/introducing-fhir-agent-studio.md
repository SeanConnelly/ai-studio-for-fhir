...
![The guided demo: all twelve agents, each with a description and a Try it link](https://github.com/SeanConnelly/ai-studio-for-fhir/tree/main/docs/screenshots/The%20Demo%20Page.png)
